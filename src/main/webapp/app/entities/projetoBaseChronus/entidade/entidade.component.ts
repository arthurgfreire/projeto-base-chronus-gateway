...
export class EntidadeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.entidadeService
      ...
      .subscribe(
        (res: HttpResponse<IEntidade[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IEntidade): string {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInEntidades(): void {
    this.eventSubscriber = this.eventManager.subscribe('entidadeListModification', () => this.loadPage());
  }

  delete(entidade: IEntidade): void {
    const modalRef = this.modalService.open(EntidadeDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IEntidade[] | null, headers: HttpHeaders, page: number): void {
