...
export class UfComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.ufService
      ...
      .subscribe(
        (res: HttpResponse<IUf[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IUf): string {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInUfs(): void {
    this.eventSubscriber = this.eventManager.subscribe('ufListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IUf[] | null, headers: HttpHeaders, page: number): void {
