...
export class PaisComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.paisService
      ...
      .subscribe(
        (res: HttpResponse<IPais[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IPais): string {
  ...
  protected onSuccess(data: IPais[] | null, headers: HttpHeaders, page: number): void {
