...
export class CidadeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.cidadeService
      ...
      .subscribe(
        (res: HttpResponse<ICidade[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: ICidade): string {
  ...
  protected onSuccess(data: ICidade[] | null, headers: HttpHeaders, page: number): void {
