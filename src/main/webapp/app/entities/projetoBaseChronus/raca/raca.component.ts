...
export class RacaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.racaService
      ...
      .subscribe(
        (res: HttpResponse<IRaca[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IRaca): string {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInRacas(): void {
    this.eventSubscriber = this.eventManager.subscribe('racaListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IRaca[] | null, headers: HttpHeaders, page: number): void {
