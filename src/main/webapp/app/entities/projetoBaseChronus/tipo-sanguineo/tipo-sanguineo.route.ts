...
import { ITipoSanguineo, TipoSanguineo } from 'app/shared/model/projetoBaseChronus/tipo-sanguineo.model';
...
export const tipoSanguineoRoute: Routes = [
  {
    ...
    data: {
      ...
      defaultSort: 'id,asc',
      pageTitle: 'projetoBaseChronusGatewayApp.projetoBaseChronusTipoSanguineo.home.title',
    },
